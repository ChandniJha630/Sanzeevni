...
remedy = ['Artichoke', 'Asparagus', 'Beets', 'Bell pepper', 'Broccoli', 'Brussels sprouts',
          'Cabbage', 'Carrots', 'Cauliflower', 'Celery', 'Collard greens', 'Corn', 'Cucumber', 'Eggplant', 'Fennel', 'Garlic', 'Ginger', 'Green beans', 'Kale', 'Leeks', 'Lettuce', 'Mushrooms', 'Okra', 'Onion', 'Parsnips', 'Peas', 'Potatoes', 'Pumpkin', 'Radishes', 'Spinach', 'Squash', 'Sweet potatoes', 'Tomatoes', 'Turnips', 'Watercress',
          'Zucchini', 'Artichoke hearts', 'Chives', 'Garlic scapes', 'Jerusalem artichokes', 'Kohlrabi', 'Rhubarb']
...
S1Lb = Label(root, text="Symptom 1", fg="white", bg="#86C8BC")
S1Lb.grid(row=9, column=0, pady=10, sticky=W)

S2Lb = Label(root, text="Symptom 2", fg="white", bg="#86C8BC")
S2Lb.grid(row=10, column=0, pady=10, sticky=W)

S3Lb = Label(root, text="Symptom 3", fg="white", bg="#86C8BC")
S3Lb.grid(row=11, column=0, pady=10, sticky=W)

S4Lb = Label(root, text="Symptom 4", fg="white", bg="#86C8BC")
S4Lb.grid(row=12, column=0, pady=10, sticky=W)

S5Lb = Label(root, text="Symptom 5", fg="white", bg="#86C8BC")
S5Lb.grid(row=13, column=0, pady=10, sticky=W)


lrLb = Label(root, text="Remedy", fg="white", bg="#86C8BC")
lrLb.grid(row=15, column=2, pady=10,sticky=W)

destreeLb = Label(root, text="Remedy", fg="white", bg="#86C8BC")
destreeLb.grid(row=17, column=2, pady=10, sticky=W)

ranfLb = Label(root, text="Remedy", fg="white", bg="#86C8BC")
ranfLb.grid(row=19, column=2, pady=10, sticky=W)
...
dst = Button(root, text="Possiblity1", command=DecisionTree,bg="green",fg="yellow")
dst.grid(row=15, column=0,padx=10)

rnf = Button(root, text="Possiblity2", command=randomforest,bg="green",fg="yellow")
rnf.grid(row=17, column=0,padx=10)

lr = Button(root, text="Possiblity3", command=NaiveBayes,bg="green",fg="yellow")
